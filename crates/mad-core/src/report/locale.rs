...
pub struct ReportStrings {
    ...
    pub section_compare: &'static str,
    pub compare_leaderboard: &'static str,
    pub compare_pillar_radar: &'static str,
...
const STRINGS_EN: ReportStrings = ReportStrings {
    ...
    section_compare: "Vendor Comparison",
    compare_leaderboard: "Leaderboard",
    compare_pillar_radar: "Pillar Radar",
    col_id: "ID",
...
const STRINGS_FR: ReportStrings = ReportStrings {
    ...
    section_compare: "Comparaison des éditeurs",
    compare_leaderboard: "Classement",
    compare_pillar_radar: "Radar par pilier",
    col_id: "ID",
